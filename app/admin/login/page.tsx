...
export default function AdminLoginPage() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    if (res.ok) {
      // Full navigation rather than router.push: the client router can send
      // the RSC request for /admin before the just-set session cookie is
      // attached, getting redirected back to /login. A real navigation
      // always carries the cookie correctly.
